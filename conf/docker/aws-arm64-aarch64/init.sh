...
wget -P /home/ubuntu -O /home/ubuntu/janction-node "https://janction-datas.s3.ap-northeast-1.amazonaws.com/linux-arm/janction-node"
if [ $? -ne 0 ]; then
  echo "Download janction-node Failed"
  exit 1
fi
chmod +x /home/ubuntu/janction-node
wget -P /home/ubuntu -O /home/ubuntu/config.json "https://janction-datas.s3.ap-northeast-1.amazonaws.com/linux-arm/config.json"
if [ $? -ne 0 ]; then
